...
CREATE TABLE `FerEtatChantier` (
    ...
    INDEX `FerEtatChantier_rapportId_idx`(`rapportId`),
    INDEX `FerEtatChantier_rapportId_etatDate_idx`(`rapportId`, `etatDate`),
    PRIMARY KEY (`id`)
...
CREATE TABLE `FerRestantNonConfectionne` (
    ...
    INDEX `FerRestantNonConfectionne_rapportId_idx`(`rapportId`),
    INDEX `FerRestantNonConfectionne_rapportId_rapportDate_idx`(`rapportId`, `rapportDate`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `FerRapport` (
    ...
    INDEX `FerRapport_chantierName_idx`(`chantierName`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `FerEtatChantier` ADD CONSTRAINT `FerEtatChantier_rapportId_fkey` FOREIGN KEY (`rapportId`) REFERENCES `FerRapport`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `FerRestantNonConfectionne` ADD CONSTRAINT `FerRestantNonConfectionne_rapportId_fkey` FOREIGN KEY (`rapportId`) REFERENCES `FerRapport`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
